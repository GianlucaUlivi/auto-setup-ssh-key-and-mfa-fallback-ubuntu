...
echo "If you face any isse and wish to rollback the changes you can replace the newly created config files with their backup."
echo "The backup files have been automatically created at the following locations:"
echo "- ${USER_SSH_DIR}/authorized_keys.bak"
